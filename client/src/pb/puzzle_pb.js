...
goog.exportSymbol('proto.crossme.PuzzleIndex', null, global);
/**
 ...
 * @constructor
 */
proto.crossme.PuzzleIndex = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.crossme.PuzzleIndex, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.crossme.PuzzleIndex.displayName = 'proto.crossme.PuzzleIndex';
}
...
black: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
circled: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
...
/**
 * @param {number} value
 * @return {!proto.crossme.Puzzle.Cell} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.crossme.Puzzle.Clue} returns this
 */
 ...
 * @return {!proto.crossme.Puzzle.Meta} returns this
*/
...
/**
 * @param {string} value
 * @return {!proto.crossme.Puzzle} returns this
 */
...
proto.crossme.Puzzle.prototype.clearAcrossCluesList = function() {
  return this.setAcrossCluesList([]);
};
 ...
 * @return {!Object}
 */
proto.crossme.PuzzleIndex.prototype.toObject = function(opt_includeInstance) {
  return proto.crossme.PuzzleIndex.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.crossme.PuzzleIndex} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.crossme.PuzzleIndex.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.crossme.PuzzleIndex.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.crossme.PuzzleIndex;
  return proto.crossme.PuzzleIndex.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.crossme.PuzzleIndex} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.crossme.PuzzleIndex}
 */
proto.crossme.PuzzleIndex.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.crossme.PuzzleIndex.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.crossme.PuzzleIndex.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.crossme.PuzzleIndex} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.crossme.PuzzleIndex.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.crossme.PuzzleIndex.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.crossme.PuzzleIndex} returns this
 */
proto.crossme.PuzzleIndex.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.crossme.PuzzleIndex.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.crossme.PuzzleIndex} returns this
 */
proto.crossme.PuzzleIndex.prototype.setTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.crossme.PuzzleIndex.prototype.getDate = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.crossme.PuzzleIndex} returns this
 */
proto.crossme.PuzzleIndex.prototype.setDate = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
