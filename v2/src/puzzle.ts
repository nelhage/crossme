...
const puzzle: Puzzle = Object.freeze({
  "title": "February 27, 2019  - \"Ancient Capitals\" - Anna Gundlach, edited by Ben Tausig",
  ...
  "down_clues": [
    ...
    {
      "number": 4,
      "text": "Thing you might have to zoom all the way in on to see with Google Earth"
    },
    {
      "number": 5,
    ...
    {
      "number": 40,
      "text": "Gross candy flavor that doesn't taste like the fruit it references, and yet which somehow remains inexplicably popular"
    },
    {
      "number": 41,
    ...
    {
      "number": 43,
      "text": "Active volcano where the borders of ten municipalities meet at the summit"
    },
    {
      "number": 45,
  ...
  "across_clues": [
    ...
    {
      "number": 44,
      "text": "Where to park yourself for a sampler at the local craft distillery?"
    },
    {
      "number": 48,
